...
n_embd = metadata.get("qwen35.embedding_length") or metadata.get("general.embedding_length")
n_vocab = metadata.get("qwen35.vocab_size") or metadata.get("general.vocab_size")
